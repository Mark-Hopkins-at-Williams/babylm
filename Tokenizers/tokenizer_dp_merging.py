...
from DP_mergeEntries import dp_merge_inputs
import random
...
def tokenize(element):
    outputs = TOKENIZER(element["text"], truncation=True, 
    ...
    #random.shuffle(merged_inputs)
    #print(len(outputs["input_ids"]), len(merged_inputs))
