...
def create_multiple_files_dataset_dict(change_dataset, ex, bos_tok=None, eos_tok=None):
    ...
    train_corpora = [dataset for dataset in train_corpora if dataset != change_dataset]
