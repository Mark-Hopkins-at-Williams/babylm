...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[6000:38500]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/aochildes_len_16k_rarity_all_6k_1.2k.train', 'w') as f:
