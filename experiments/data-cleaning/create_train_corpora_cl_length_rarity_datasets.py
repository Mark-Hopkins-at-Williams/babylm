...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[7000:18500]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/gutenberg_rarity_all_7k_3k.train', 'w') as f:
