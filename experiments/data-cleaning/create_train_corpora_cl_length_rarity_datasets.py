...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[2000:39000]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/aochildes_len_16k_rarity_all_2k_p7k.train', 'w') as f:
