...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[1500:]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/aochildes_length_17p5k.train', 'w') as f:
