...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[29000:740000]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/all_rarity_all_29k_3k.train', 'w') as f:
