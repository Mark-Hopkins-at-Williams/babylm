...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[3500:-1800]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/guten_rarity_all_3p5k_1p8k.train', 'w') as f:
