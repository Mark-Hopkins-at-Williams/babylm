...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[15000:69500]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/bnc_rarity_all_15k_1k.train', 'w') as f:
