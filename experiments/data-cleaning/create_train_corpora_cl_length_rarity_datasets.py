...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[30000:724000]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/all_mod_aochildes_rarity_all_30k_3k.train', 'w') as f:
