...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[:-3300]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/aochildes_rarity_end_3p3k.train', 'w') as f:
