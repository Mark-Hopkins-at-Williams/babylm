...
def create_multiple_files_dataset_dict(one_dataset):
    if one_dataset:
        corpora = ['cbt_rarity_all_end_p5k', 'guten_rarity_all_end_2p5k']
    else:
        corpora = ['bnc_spoken', 'open_subtitles', 'aochildes', 
               'children_stories', 'cbt_rarity_all_end_p5k', 'guten_rarity_all_end_2p5k', 
...
with open('/mnt/storage/nasimb/babylm_data/babylm_10M/cbt_p5k_guten_2p5k_rarity_all.train', 'w') as f:
