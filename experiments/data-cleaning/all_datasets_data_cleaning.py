...
train_dataset_raw_cleaned = list(dict.fromkeys(train_dataset_raw_cleaned))[5500:]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/all_mod_datasets1_rarity_all_5p5k_mostf.train', 'w') as f:
