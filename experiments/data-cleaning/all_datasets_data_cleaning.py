...
train_dataset_raw_cleaned = sorted(list(dict.fromkeys(train_dataset_raw_cleaned)))#, reverse=True)

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/all_mod_datasets1_rarity_all_iorder_c13k_c2p6k_rev.train', 'w') as f:
