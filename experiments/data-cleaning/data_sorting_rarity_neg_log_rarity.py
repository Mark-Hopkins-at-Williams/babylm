...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[:-800]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/cbt_rarity_neg_log_rarity_end_p8k.train', 'w') as f:
