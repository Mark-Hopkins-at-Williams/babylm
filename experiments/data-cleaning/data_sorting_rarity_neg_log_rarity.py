...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[:19100]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/guten_rarity_neg_log_rarity_end_19p1k.train', 'w') as f:
