...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[1500:19500]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/guten_norm_rarity_neg_log_rarity_1p5k_end_19p5k.train', 'w') as f:
