from tokenize_and_data_gpt2_concat_cl import create_multiple_files_dataset_dict, tokenize, TOKENIZER, CONTEXT_LENGTH 
...
args = TrainingArguments(
    output_dir="gpt2-concat-cl-log-rarity-10-220k-mod-datasets-rarity1-root3",
