...
def train_model(miss_dataset):
    ...
    raw_datasets = create_multiple_files_dataset_dict(miss_dataset)
    ...
    model_name = f"all-base-miss-{miss_dataset}-seed"
...
miss_one_corpora = ['aochildes', 'bnc_spoken', 'open_subtitles',
               'children_stories', 'gutenberg_fixed', 'cbt'
               'qed', 'simple_wikipedia', 'switchboard', 'wikipedia']          
for dataset in miss_one_corpora:
    train_model(dataset)
