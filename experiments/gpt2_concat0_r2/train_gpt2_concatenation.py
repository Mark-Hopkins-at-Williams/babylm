...
with Popen(['python','/mnt/storage/nasimb/evaluation-pipeline/babylm_eval.py', '/mnt/storage/nasimb/babylm/bnc-log-rarity', 'decoder'], stdout=PIPE, universal_newlines=True) as p:
