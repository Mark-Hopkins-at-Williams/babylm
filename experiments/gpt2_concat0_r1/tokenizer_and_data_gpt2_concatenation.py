...
def create_multiple_files_dataset_dict(log_rarity_dataset, bos_tok=None, eos_tok=None):
    ...
    train_corpora = [dataset for dataset in train_corpora if dataset != log_rarity_dataset]
    
    train_corpora = [f'../babylm_data/babylm_10M/{corpus}.train' for corpus in train_corpora]
    train_corpora.append(f"/mnt/storage/nasimb/babylm_data/10M_log_rarity/{log_rarity_dataset}_log_rarity.train")
