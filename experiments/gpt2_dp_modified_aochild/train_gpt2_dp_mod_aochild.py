from tokenize_and_data_gpt2_dp_mod_aochild import create_multiple_files_dataset_dict, tokenize, TOKENIZER, CONTEXT_LENGTH 
...
args = TrainingArguments(
    output_dir="gpt2-dp-mod-aochild-10chars",
