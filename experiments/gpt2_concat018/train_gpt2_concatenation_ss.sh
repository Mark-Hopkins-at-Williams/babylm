...
python /mnt/storage/nasimb/babylm/experiments/gpt2_concat018/train_gpt2_concatenation.py
cd ../evaluation-pipeline
python babylm_eval.py /mnt/storage/nasimb/babylm/cl-log-rarity-280k decoder
