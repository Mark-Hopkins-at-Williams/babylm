...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    train_corpora = ['aochildes', 'open_subtitles', #'bnc_spoken',
               'children_stories', 'gutenberg', #cbt', 
               'qed', 'simple_wikipedia', 'switchboard', 'wikipedia']
    
    train_corpora = [f'../babylm_data/babylm_10M/{corpus}.train' for corpus in train_corpora]
    train_corpora.append("/mnt/storage/nasimb/babylm_data/10M_two_mixed_log_rarity/bnc_spoken_cbt_log_rarity.train")
