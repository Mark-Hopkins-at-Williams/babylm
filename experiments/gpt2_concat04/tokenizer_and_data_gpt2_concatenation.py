...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    train_corpora.append("/mnt/storage/nasimb/babylm_data/10M_rarity/bnc_spoken_rarity.train")
    train_corpora.append("/mnt/storage/nasimb/babylm_data/10M_rarity/cbt_rarity.train")
