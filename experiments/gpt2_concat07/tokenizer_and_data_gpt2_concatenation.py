...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    """train_corpora = ['aochildes', 'bnc_spoken', 'open_subtitles',
               'children_stories', 'cbt', 'guten_rarity_neg_log_rarity', 
    ...
    train_corpora = ["/mnt/storage/nasimb/babylm_data/babylm_10M/all_base_rarity_neg_log_rarity_rev_no_shuffle.train"]
    print(train_corpora)
