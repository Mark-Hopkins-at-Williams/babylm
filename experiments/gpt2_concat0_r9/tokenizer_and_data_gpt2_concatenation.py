...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    train_corpora = [ 'open_subtitles', 'bnc_spoken', #'aochildes',
    ...
    train_corpora.append("/mnt/storage/nasimb/babylm_data/10M_two_mixed_rarity/aochildes_gutenberg_fixed_rarity.train")
