...
args = TrainingArguments(
    output_dir="aochildes-guten-fixed-rarity-mixed",
...
with Popen(['python','/mnt/storage/nasimb/evaluation-pipeline/babylm_eval.py', '/mnt/storage/nasimb/babylm/aochildes-guten-fixed-rarity-mixed', 'decoder'], stdout=PIPE, universal_newlines=True) as p:
