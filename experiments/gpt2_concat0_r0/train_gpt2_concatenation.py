...
def train_model(rarity_dataset):
    ...
    raw_datasets = create_multiple_files_dataset_dict(rarity_dataset)
    ...
    model_name = f"{rarity_dataset}-rarity-seed"
...
rarity_corpora = ['aochildes', 'bnc_spoken', 'open_subtitles',
