...
args = TrainingArguments(
    output_dir="cbt-rarity-guten-fixed",
...
with Popen(['python','/mnt/storage/nasimb/evaluation-pipeline/babylm_eval.py', '/mnt/storage/nasimb/babylm/cbt-rarity-guten-fixed', 'decoder'], stdout=PIPE, universal_newlines=True) as p:
