...
args = TrainingArguments(
    output_dir="bnc-cbt-rarity-mixed",
...
with Popen(['python','/mnt/storage/nasimb/evaluation-pipeline/babylm_eval.py', '/mnt/storage/nasimb/babylm/bnc-cbt-rarity-mixed', 'decoder'], stdout=PIPE, universal_newlines=True) as p:
