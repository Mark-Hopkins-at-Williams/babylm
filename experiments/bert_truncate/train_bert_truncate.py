from tokenize_and_data_bert_truncate import create_multiple_files_dataset_dict, tokenize, TOKENIZER, CONTEXT_LENGTH 
...
print([len(i) for i in tokenized_datasets["train"]['input_ids'] if len(i) > 128])
