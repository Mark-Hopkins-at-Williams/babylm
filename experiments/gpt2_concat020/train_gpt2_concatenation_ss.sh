...
python /mnt/storage/nasimb/babylm/experiments/gpt2_concat020/train_gpt2_concatenation.py
cd ../evaluation-pipeline
python babylm_eval.py /mnt/storage/nasimb/babylm/all-base-rerun-new-loop2 decoder
