...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    train_corpora = ['aochildes', 'bnc_spoken', 'open_subtitles',
               'children_stories', 'cbt', 'guten_norm_rarity_neg_log_rarity_end_19p5k', 
    ...
    #train_corpora = ["/mnt/storage/nasimb/babylm_data/babylm_10M/all_base_norm_rarity_log_rarity.train"]
    print(train_corpora)
