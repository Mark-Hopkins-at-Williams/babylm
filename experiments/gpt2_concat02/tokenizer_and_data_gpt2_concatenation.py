...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    train_corpora = [ 'bnc_spoken', 'open_subtitles', #'aochildes',
    ...
    train_corpora.append("/mnt/storage/nasimb/babylm_data/10M_rarity/aochildes_rarity.train")
    train_corpora.append("/mnt/storage/nasimb/babylm_data/10M_rarity/gutenberg_fixed_rarity.train")
