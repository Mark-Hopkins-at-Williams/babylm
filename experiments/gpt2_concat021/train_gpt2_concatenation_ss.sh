...
python /mnt/storage/nasimb/babylm/experiments/gpt2_concat021/train_gpt2_concatenation.py
cd ../evaluation-pipeline
python babylm_eval.py /mnt/storage/nasimb/babylm/guten-rarity-all-beg-2k decoder
