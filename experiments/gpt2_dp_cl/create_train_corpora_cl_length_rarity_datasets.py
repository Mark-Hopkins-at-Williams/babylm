...
sorted_list_train_dataset_raw = list(dict.fromkeys(sorted_list_train_dataset_raw))[1000:]

with open('/mnt/storage/nasimb/babylm_data/babylm_10M/aochild_rarity3_all_1k.train', 'w') as f:
