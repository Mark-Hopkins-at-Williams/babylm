...
def create_multiple_files_dataset_dict(bos_tok=None, eos_tok=None):
    ...
    train_corpora = ['aochildes_len', 'bnc_spoken', 'open_subtitles',
    ...
    #train_corpora = ["/mnt/storage/nasimb/babylm_data/babylm_10M/all_base_norm_rarity_neg_log_rarity_23k_end_741k.train"]
    print(train_corpora)
